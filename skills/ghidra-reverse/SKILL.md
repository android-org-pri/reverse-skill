...
3. `NEXT`: 读 [../tool-index.md](../tool-index.md) 查 ghidra / ghidra-mcp 路径
...
- [references/ghidra-cheatsheet.md](references/ghidra-cheatsheet.md)
- [../ida-reverse/](../ida-reverse/) [../radare2/](../radare2/) [../binary-diff/](../binary-diff/)
